...
{
    class BasicEnumerateClassNames
    {
        public static void Main(string[] args)
        {
            ...
            Console.Write("Enumerating Class Names... ");
            CimNameList items = client.EnumerateClassNames();
            Console.WriteLine("Done.\n");

            // Display the results
            Console.WriteLine("Class Names in Namespace");
            Console.WriteLine("------------------------");
            foreach (CimName curItem in items)
            {
